...
from MAA.ldm.modules.x_transformer import Encoder, TransformerWrapper  # TODO: can we directly rely on lucidrains code and simply add this as a reuirement? --> test
from torch.utils.checkpoint import checkpoint
from transformers import T5Tokenizer, T5EncoderModel, CLIPTokenizer, CLIPTextModel, AutoTokenizer
from importlib_resources import files
from MAA.ldm.modules.encoders.CLAP.utils import read_config_as_args
from MAA.ldm.modules.encoders.CLAP.clap import TextEncoder
from MAA.ldm.util import default, count_params
...
class FrozenCLAPEmbedder(AbstractEncoder):
    ...
    def __init__(self, weights_path=None, freeze=True, device="cuda", max_length=77):  # clip-vit-base-patch32
        ...
        config_as_str = files('MAA.ldm').joinpath('modules/encoders/CLAP/config.yml').read_text()
